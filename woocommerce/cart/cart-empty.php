...
<div class="cart-empty-wrapper bg-white py-16 md:py-24 text-center font-body min-h-[60vh] flex flex-col items-center justify-center">
    <div class="max-w-md mx-auto px-4">
        ...
        <div class="w-20 h-20 mx-auto rounded-full bg-[#FFF9F4] border border-[#F5EBE1] flex items-center justify-center text-[#CC5600] mb-6 shadow-xs" aria-hidden="true">
            <svg class="w-10 h-10" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
        </div>

        <h1 class="font-body text-2xl md:text-3xl font-semibold text-[#111111] mb-2">
        ...
        >
            ...
            <svg class="w-4 h-4" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
        </a>
