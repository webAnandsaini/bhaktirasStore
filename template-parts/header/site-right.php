...
<div class="site-header-actions flex items-center gap-6 xl:gap-8 text-[#444444] font-sub">
    ...
    <!-- Wishlist Action -->
    <a href="<?php echo esc_url($wishlist_url); ?>" class="header-action-item relative flex items-center gap-2 hover:text-[#CC5600] transition-colors text-[14px] leading-none focus:outline-none focus-visible:ring-2 focus-visible:ring-[#CC5600] rounded-sm" aria-label="<?php echo esc_attr(sprintf(__('View Wishlist, %d items', 'dharmgyan'), $wishlist_count)); ?>">
        <div class="relative flex items-center justify-center">
            <svg class="w-5 h-5 flex-shrink-0 text-[#444444]" aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
            </svg>
            <span class="header-badge-count header-wishlist-count absolute -top-2.5 -right-2.5 bg-[#CC5600] text-white text-[10px] font-bold w-4 h-4 rounded-full flex items-center justify-center <?php echo $wishlist_count > 0 ? '' : 'hidden'; ?>" aria-hidden="true">
    ...
    <a href="<?php echo esc_url($account_url); ?>" class="header-action-item flex items-center gap-2 hover:text-[#CC5600] transition-colors text-[14px] leading-none focus:outline-none focus-visible:ring-2 focus-visible:ring-[#CC5600] rounded-sm" aria-label="<?php echo $is_logged_in ? esc_attr__('My Account', 'dharmgyan') : esc_attr__('Login or Register', 'dharmgyan'); ?>">
        <svg class="w-5 h-5 flex-shrink-0 text-[#444444]" aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
