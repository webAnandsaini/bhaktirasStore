 ...
 * Sourced dynamically from Theme Settings.
 * 
 * @package Dharmgyan
 */
...
$notice_text = dharmgyan_get_field('topbar_notice_text', 'option');
$cta_text    = dharmgyan_get_field('topbar_cta_text', 'option');
...
if (!$enable_topbar || (empty($notice_text) && empty($cta_text))) {
    return;
}
?>
