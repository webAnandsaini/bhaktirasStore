<?php
/**
 * Homepage & PDP 'Our Most Discount Sale' Showcase Template Part - 5 Products in 1 Row
...
if (!empty($selected_products) && is_array($selected_products)) {
    ...
    $count = dharmgyan_get_field('discount_sale_count', 'option') ? intval(dharmgyan_get_field('discount_sale_count', 'option')) : (dharmgyan_get_field('discount_sale_count') ? intval(dharmgyan_get_field('discount_sale_count')) : 5);
    $args = array(
        'post_type'      => 'product',
